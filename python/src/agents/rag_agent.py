...
class RagQueryResult(BaseModel):
    ...
    refined_query: Optional[str] = Field(description="Refined query used for search if different from original")
...
"""
        ...
        @agent.tool
        async def search_documents(ctx: RunContext[RagDependencies], query: str, source_filter: Optional[str] = None) -> str:
    ...
    def get_system_prompt(self) -> str:
        ...
        try:
            ...
            return prompt_service.get_prompt('rag_assistant', 
    ...
    async def run_conversation(self, user_message: str, project_id: Optional[str] = None, 
                              source_filter: Optional[str] = None, match_count: int = 5,
                              user_id: str = None, progress_callback: Any = None) -> RagQueryResult:
        """
