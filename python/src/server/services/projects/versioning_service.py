...
class VersioningService:
    ...
    def create_version(self, project_id: str, field_name: str, content: Dict[str, Any],
                      change_summary: str = None, change_type: str = "update",
                      document_id: str = None, created_by: str = "system") -> Tuple[bool, Dict[str, Any]]:
        """
    ...
    def restore_version(self, project_id: str, field_name: str, version_number: int,
                       restored_by: str = "system") -> Tuple[bool, Dict[str, Any]]:
        """
