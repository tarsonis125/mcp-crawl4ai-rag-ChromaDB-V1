...
<div className="hero hero--primary">
  <div className="container">
    <h1 className="hero__title">
      **Archon's MCP Integration**
    </h1>
    <h2 className="hero__subtitle">
      Connect **any AI client** to your knowledge base with 25 powerful tools and real-time monitoring
    </h2>
  </div>
</div>
...
- **🛠️ MCP Server**: Exposes 25 powerful tools for knowledge management and task organization
- **🔌 MCP Client**: Universal client for connecting to any MCP server (including Archon itself)
...
<div className="row">
  <div className="col col--6">
    <div className="card">
      ...
      <div className="card__body">
        ...
        <ul>
          <li>✅ **25 comprehensive tools** for RAG and project management</li>
          <li>🔥 **Real-time Logfire monitoring** of all tool calls</li>
          <li>🌐 **Universal compatibility** with Cursor, Windsurf, Claude Desktop</li>
          <li>📡 **Multiple transports**: stdio, SSE, WebSocket</li>
        </ul>
  ...
  <div className="col col--6">
    <div className="card">
      ...
      <div className="card__body">
        <p>**Universal MCP Client** - Connect to any MCP server from Archon's UI</p>
        <ul>
          <li>🌐 **Connect to any MCP server** (including other Archon instances)</li>
          <li>🧪 **Interactive tool testing** with real-time results</li>
          <li>📊 **WebSocket real-time updates** for collaborative workflows</li>
          <li>🔧 **Multiple transport support** with automatic detection</li>
        </ul>
...
<Tabs>
<TabItem value="server" label="🛠️ Using Archon as MCP Server" default>
...
3. **Start using 25 powerful tools** immediately
...
**Archon provides 25 comprehensive MCP tools across multiple domains:**

</Admonition>

| Category | Tools | Description | Key Features |
|----------|-------|-------------|--------------|
| **🧠 Knowledge Management** | 7 tools | Search, crawl, and manage knowledge | RAG queries, web crawling, document upload |
| **📊 Project Management** | 17 tools | Tasks, projects, documentation | Task creation, status tracking, document versioning |
| **🏥 System Health** | 1 tool | Health monitoring and diagnostics | Comprehensive system status |
...
<div className="row">
    ...
    <div className="card">
      ...
      <div className="card__body">
        <ul>
          ...
          <li>`delete_source_tool` - Source cleanup</li>
        </ul>
      </div>
    </div>
  </div>
  <div className="col col--4">
    <div className="card">
      ...
      <div className="card__body">
        <ul>
          <li>`create_project` - Project initialization</li>
          <li>`create_task` - Task management</li>
          <li>`update_task_status` - Status tracking</li>
          <li>`add_project_document` - Documentation</li>
          <li>`create_document_version` - Versioning</li>
          <li>**+12 more tools** for comprehensive project management</li>
        </ul>
      </div>
    </div>
  </div>
