...
- **MCP Server**: Exposes 30 tools for knowledge management and task organization
  ...
  <div className="col col--6">
    <div className="card">
      ...
      <div className="card__body">
        ...
        <ul>
          <li>30 comprehensive tools for RAG and project management</li>
          <li>Real-time Logfire monitoring of all tool calls</li>
          <li>Compatible with Cursor, Windsurf, Claude Desktop</li>
          <li>stdio transport for AI clients, SSE for web clients</li>
        </ul>
...
3. Begin using 30 available tools
...
**Archon provides 30 comprehensive MCP tools across multiple domains:**
...
| **📊 Project Management** | 18 tools | Tasks, projects, documentation | Task creation, status tracking, document management |
| **📄 Document Versioning** | 4 tools | Version control for documents | Create versions, view history, restore versions |
