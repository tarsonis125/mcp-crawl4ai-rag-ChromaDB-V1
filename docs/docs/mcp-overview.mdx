...
- The **MCP service** is a thin wrapper that exposes Server functionality as MCP tools
- There are NO HTTP calls between services - MCP imports Server modules directly
