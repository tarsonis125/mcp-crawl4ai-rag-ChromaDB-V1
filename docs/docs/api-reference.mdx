...
- **TaskService**: Task management with archiving and hierarchical structure
...
[
  ...
  },
  {
    ...
    "is_encrypted": true,
    "category": "api_keys",
    "description": "OpenRouter API Key for multiple models"
  }
]
```
...
|---------|------|-------------|
| `LLM_PROVIDER` | string | Provider choice: `openai`, `openrouter`, `ollama`, `google` |
