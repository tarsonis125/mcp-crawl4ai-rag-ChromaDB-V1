...
- **`mcp_api.py`**: MCP server control and Socket.IO communications (705 lines)
...
### Socket.IO Project Creation Progress

**Socket.IO Namespace** `/project`
...
// Connect to project namespace
const socket = io('/project');

// Subscribe to progress
const progressId = 'your-progress-id';
socket.emit('subscribe_progress', { progress_id: progressId });
...
Real-time task updates for projects.
