...
# 🛠️ Archon MCP Server Documentation

<div className="hero hero--primary">
  <div className="container">
    <h1 className="hero__title">
      **Connect Any AI Client to Archon**
    </h1>
    <h2 className="hero__subtitle">
      Expose 25 powerful tools to **Cursor**, **Windsurf**, **Claude Desktop**, and more
    </h2>
  </div>
</div>
...
Archon's MCP Server exposes your knowledge base and project management capabilities to any MCP-compatible AI client. With **25 comprehensive tools**, real-time Logfire monitoring, and multiple transport options, you can supercharge your AI workflows instantly.
...
<Admonition type="info" icon="🛠️" title="25 Powerful MCP Tools">

Archon provides the most comprehensive MCP tool collection available, organized into logical categories for maximum productivity.
