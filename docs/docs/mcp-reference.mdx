...
<Admonition type="success" icon="🎉" title="25 MCP Tools Available">
...
<Admonition type="info" icon="📊" title="Tool Distribution">
- **🧠 RAG Module**: 7 tools for knowledge search and management
- **📊 Project Module**: 17 tools for task and project management  
- **🏥 Core Server**: 1 health check tool
- **🔥 Monitoring**: All tools include comprehensive Logfire tracing
</Admonition>

### 🧠 Knowledge Management Tools (7 tools)

<Tabs>
<TabItem value="search" label="🔍 Search Tools" default>
...
<TabItem value="management" label="📚 Content Management">
...
<TabItem value="tasks" label="✅ Task Management">
...
<TabItem value="documents" label="📝 Documentation">
...
<Admonition type="tip" icon="🔥" title="Complete Observability">
...
- **🔍 Detailed Traces**: Drill down into specific tool executions
...
<Tabs>
<TabItem value="basic" label="🔍 Basic Searches" default>
...
<Tabs>
<TabItem value="stdio" label="📡 stdio (Recommended)" default>
...
<Tabs>
<TabItem value="connection" label="🔌 Connection Issues" default>
