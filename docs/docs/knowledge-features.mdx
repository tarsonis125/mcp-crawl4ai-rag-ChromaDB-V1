...
- **Progress Monitoring**: Live crawl status via WebSocket
...
### WebSocket Progress
- **Crawl Progress**: Percentage completion
- **Current URL**: What's being processed
- **Batch Updates**: Processing batches
- **Error Reporting**: Failed URLs
- **Completion Status**: Final statistics
...
// Progress message format
{
  ...
  "data": {
    ...
    "totalPages": 150,
    "processedPages": 68,
    "log": "Batch 5/10: Processing items 61-75..."
  }
}
```
