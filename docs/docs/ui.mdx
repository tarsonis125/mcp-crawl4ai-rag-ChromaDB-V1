...
All WebSocket connections in the frontend use the **EnhancedWebSocketService** for consistent behavior:

### Key Services Using WebSockets

| Service | Purpose | Status |
|---------|---------|--------|
| `crawlProgressServiceV2` | Progress tracking for crawling | ✅ Migrated |
| `websocketService` | General WebSocket management | ✅ Migrated |
| `taskUpdateWebSocket` | Real-time task updates | ✅ Migrated |
| `agentChatService` | Agent chat streaming | ✅ Migrated |
...
**DO:**
- ✅ Use EnhancedWebSocketService for all WebSocket connections
...
**DON'T:**
- ❌ Create direct WebSocket instances with `new WebSocket()`
