...
2. **MCP Service (Port 8051)**: A **thin protocol wrapper** that exposes Server functionality as MCP tools
3. **Agents Service (Port 8052)**: Contains **ONLY** PydanticAI agents that use MCP tools

**There is NO business logic outside the Server. MCP and Agents are lightweight consumers of Server functionality.**
...
- **No Inter-Service HTTP**: Within Python, services import directly - no HTTP calls between containers
- **MCP is a Wrapper**: MCP simply imports Server services and exposes them as tools
- **Agents are Pure AI**: Agents only contain PydanticAI logic and use MCP tools for everything else
- **ML Models in Server**: ALL ML models (embeddings, reranking, etc.) belong in Server, NOT in Agents
...
graph TB
    subgraph "🐳 Docker Microservices Environment"
        subgraph "🚀 Server Service (Archon-Server)"
            FastAPI["⚡ FastAPI Application<br/>Port 8080"]
            WS["📡 Socket.IO Server<br/>Port 8080"]
        end
        
        subgraph "🔌 MCP Service (archon-mcp)"
            MCP["🤖 MCP Server<br/>Port 8051<br/>14 AI Tools"]
        end
        
        subgraph "⚙️ Agents Service (archon-agents)"
            Agents["🧠 AI Processing<br/>Port 8052<br/>Document & Task Agents"]
        end
        
        subgraph "🌐 Frontend (archon-frontend)"
            React["⚛️ React + Vite<br/>Port 3737"]
        end
        
        subgraph "📚 Docs (archon-docs)"
            Docs["📖 Docusaurus<br/>Port 3838"]
        end
    end
  ...
  <div className="col col--4">
    <div className="card">
      <div className="card__header">
        <h4>⚡ **Server Service (Archon-Server)**</h4>
      </div>
    ...
    <div className="card">
      ...
      <div className="card__body">
        <ul>
          ...
          <li>Imports Server services directly</li>
          <li>NO business logic</li>
          <li>NO ML models</li>
          <li>Simply wraps Server functions as MCP tools</li>
          <li>Port: **8051**</li>
        </ul>
