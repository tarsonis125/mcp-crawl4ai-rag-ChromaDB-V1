...
graph TB
    ...
    class FastAPI,MCP,WS,BG,React neonCore
    class Supabase,OpenAI,Logfire neonExternal
    class Uploads,Logs,Config neonSystem
```
...
│   │   │   └── docs_agent.py    # Documentation processing agent (356 lines)
│   │   ├── modules/             # 📦 MCP tool modules (25 total tools)
│   │   │   ├── __init__.py      # Module initialization
│   │   │   ├── models.py        # Pydantic data models (208 lines)
│   │   │   ├── rag_module.py    # RAG functionality (7 MCP tools, 1225 lines)
│   │   │   └── project_module.py# Project & task management (17 MCP tools, 1065 lines)
