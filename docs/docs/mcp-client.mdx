...
<div className="hero hero--primary">
  <div className="container">
    ...
    <h2 className="hero__subtitle">
      Universal client for **testing**, **managing**, and **integrating** with any MCP server
    </h2>
  </div>
</div>
...
Archon's Universal MCP Client allows you to connect to and interact with any MCP (Model Context Protocol) server directly from Archon's web interface. Test tools, manage connections, and integrate multiple MCP servers into your workflow with a beautiful, intuitive UI.
...
<div className="row">
  <div className="col col--6">
    <div className="card">
      ...
      <div className="card__body">
        <ul>
          <li>✅ **Multiple transports**: stdio, Docker, SSE, NPX</li>
  ...
  <div className="col col--6">
    <div className="card">
      ...
      <div className="card__body">
        <ul>
          <li>🛠️ **Real-time tool execution** with live results</li>
          <li>📊 **Parameter validation** and type checking</li>
          <li>🎨 **Beautiful UI** for tool testing and exploration</li>
          <li>📡 **WebSocket updates** for collaborative workflows</li>
        </ul>
      </div>
    </div>
  </div>
...
| Client | Type | Description | Status |
|--------|------|-------------|---------|
| **🏰 Archon** | Docker | Your local Archon instance | ✅ Real connection |
| **🔍 Brave Search** | NPX | Web search capabilities | 🧪 Demo (for UI testing) |
| **📁 Filesystem** | stdio | Local file operations | 🧪 Demo (for UI testing) |
...
**Best for**: Containerized MCP servers, Archon instances

```json title="Docker Configuration Example"
{
  "name": "External Archon",
  "transport": "docker",
  "config": {
    "container": "other-archon-pyserver",
...
**Use Cases:**
- ✅ Connecting to other Archon instances
...
**Best for**: Local executables, Python scripts, direct process communication
...
- ✅ Direct executable communication
- ✅ Custom server scripts

</TabItem>
<TabItem value="sse" label="🌐 Server-Sent Events (SSE)">

**Best for**: Remote MCP servers, web-based servers, HTTP APIs
...
**Best for**: Node.js MCP packages, npm-published servers

```json title="NPX Configuration Example"
{
