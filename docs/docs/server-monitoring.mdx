...
# Development & Troubleshooting (Optional)
...
### Advanced Debugging with Logfire

For detailed request tracing and performance debugging, you can optionally enable [Logfire](https://logfire.pydantic.dev/):

1. **Get a Logfire token** from [logfire.pydantic.dev](https://logfire.pydantic.dev/)
2. **Add to your .env file**: `LOGFIRE_TOKEN=your_logfire_token`
3. **View traces** in the Logfire dashboard for detailed request flows

This provides real-time debugging for RAG queries, MCP tool calls, and API performance analysis.
