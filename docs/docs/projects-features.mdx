...
- **Hierarchical Structure**: Projects contain tasks, documents, and features
...
- **Parent-Child Tasks**: Create subtasks for complex work
...
- **Tasks Table**: Hierarchical task storage with relationships
...
### Task Breakdown
```
AI Assistant: "Break down the 'Implement login form' task into subtasks"
```
The AI will create:
